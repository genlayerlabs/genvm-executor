let
  ...
  src = rec {
    ...
    pyLibs = {
      ...
      genlayer-std = {
        hash = "sha256-U56UmY3im2Tlua69T4vdVp5jAr/GkD4edBrEZqCbsDg=";
        depends = [
          top
        ];
      };
    ...
    wrappers = {
      __prefix = "";
      py-genlayer = {
        hash = "sha256-MYYcyvObIeS2Ctc8IJbHoKzdxxdUVM3pGh4TW8O23Jw=";
        depends = [
          cpython
          pyLibs.cloudpickle
          pyLibs.genlayer-std
      ...
      py-genlayer-multi = {
        hash = "sha256-m4Yy55954X9H0XU56J3Cnw8fBZM6XgZ46p2FYsb8Klo=";
        depends = [
          cpython
          pyLibs.cloudpickle
          pyLibs.genlayer-std
