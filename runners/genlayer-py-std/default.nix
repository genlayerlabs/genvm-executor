...
in
(runnersLib.toListExcluded runnersLib.hashes.pyLibs.genlayer-std (
  runnersLib.packageWithRunnerJSON {
    ...
    baseDerivation = lib.sources.cleanSourceWith {
      ...
      filter =
        fName: type:
        lib.sources.cleanSourceFilter fName type && !(type == "directory" && fName == "__pycache__");
...
++
  ...
  (runnersLib.toListExcluded runnersLib.hashes.pyLibs.genlayer-embeddings (
    runnersLib.packageWithRunnerJSON {
      ...
      expr = {
        Seq = [
          ...
          {
            MapFile = {
              file = "genlayer_embeddings/";
              to = "/py/libs/genlayer_embeddings/";
            };
          }
          {
            MapFile = {
...
++
  ...
  (runnersLib.toListExcluded runnersLib.hashes.wrappers.py-genlayer (
    runnersLib.packageGlue {
...
++
  ...
  (runnersLib.toListExcluded runnersLib.hashes.wrappers.py-genlayer-multi (
    runnersLib.packageGlue {
