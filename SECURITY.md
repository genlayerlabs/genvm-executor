...
GenVM is consensus-critical: the executor runs Intelligent Contracts and its output must be
...
1. **Remote code execution** — escaping the WASM/VM sandbox, or running attacker code in a
   validator or the build pipeline.
